...
let promise = Promise.all([p1, p2, p3]) // will be resolved if all the promise all resolved
// let promise = Promise.allSettled([p1, p2, p3]) //will be resolved once all are settled with resolved or rejected
// let promise = Promise.race([p1, p2, p3]) //will return the promise which ever is settled first either resolved or rejected
